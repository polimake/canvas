...
import { PAGE_SIZE_PRESETS, listPages, resizePage, goToPage, type PageInfo, type PageSize } from '../core/pages';
import { getPageBackground, setPageBackgroundColor } from '../core/background';
