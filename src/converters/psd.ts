 ...
 *             navegador. Quien lee bytes es `parsers/psd.ts`.
 *
...
export type * from '../documents/psd';
import type { PsdUnits, PsdColor, PsdTextStyle, PsdText, PsdBezierPath, PsdEffect, PsdLayer, PsdDocument } from '../documents/psd';
